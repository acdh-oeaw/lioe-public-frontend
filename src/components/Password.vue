<template>
  <div class="pa-5 text-center fill-height">
    ...
    <p class="grey--text">
      ...
      Hinweise zu unserem Forschungsdatenmanagement finden Sie <a href="https://lioe-cms.dioe.at/wboe-artikel/hinweise-zum-forschungsdatenmanagement/" target="_blank" @click.prevent="subDialog = true">hier</a>.<br>
